            ...
            return(
               ...
               <div className="single-products-box border">
                  ...
                  <div className="row  align-items-center product-div">
                     ...
                     <Link to={"/SingleProduct/" + el._id} className="product-image-link">
                        ...
                        <Link to={"/SingleProduct/" + el._id}>
                           ...
                           <div className="price-div justify-content-center align-items-center d-flex">
                            ...
                            <del className="new-price ml-1">{el.inrMrp}</del>
                              {Userdata ? (
                              <i className="bx bxs-heart ml-3" onClick={() => {
                        AddtoWishlist(
                          el._id,
                          el.name,
                          quantity,
                          ...
                          el.image
                                  ...
                                  <>
                                 <i className="bx bxs-heart ml-3 pc-heart"  data-bs-toggle="modal"
                      data-bs-target={Userdata == null ? "#exampleModal" : null}></i>
                      <Link to="/Register">
