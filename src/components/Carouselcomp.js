  ...
  <div className="container-fluid container-carousel  ">
    ...
    <div id="banner">
            <a href="/">
                ...
                <div id="sale">
                    <span id="sale-text">30% off All Premium Products</span><br/>
     ...
     <div class="row mt-3">
      ...
      <img src={require('../Images/products/L1Sachet_400x 1.png')} alt="image" className=".img-button"></img> 
...
<div className="justify-content-center align-items-center d-flex caresouel-shop-div">
  <button> Shop now</button>
      ...
      <div class="container image-button">
      <img src={require('../Images/products/walk-easy-capsules-250x250.png')} alt="image" className=".img-button"></img> 
  {/* <div class="overlay"></div> */}
  {/* <div class="button-hover"><button> ShopNow </button></div> */}
...
<div class="container image-button">
<img src={require('../Images/products/TenchalotionListingcopy_400x-removebg-preview.png')} alt="image" className=".img-button"></img> 
{/* <div class="overlay"></div> */}
{/* <div class="button-hover"><button> ShopNow </button></div> */}
...
<div class="container image-button">
<img src={require('../Images/products/Hepamax 1.png')} alt="image" className=".img-button"></img> 
{/* <div class="overlay"></div> */}
{/* <div class="button-hover"><button> ShopNow </button></div> */}
...
<button> Shop now</button>
  ...
  <div className="container-fluid container-carousel pt-5 pb-5">
    ...
    <div className="col-4">
      ...
      <p className=" heading mt-4">Using a 5 layers surgical mask, we can protect ourselves from various germs. Everyone should use this 5 layers surgical mask</p>
      <button className="btn btn-primary carousel-button"><i class='bx bx-cart'></i> Buy now</button>
    </div>
    <div className="col-1"></div>
      <div className="col-4"><img src={require('../Images/header-image.png')} className="Carousel-img" alt="image" /></div>
      <div className="col-2"><i class='bx bx-chevron-left carousel-LR'></i> <i class='bx bx-chevron-right carousel-LR ml-2'></i></div>
    </div>
  </div>
  <div className="container-fluid container-carousel pt-5 pb-5">
  ...
  <div className="container-fluid container-carousel pt-5 pb-5">
    ...
    <div className="col-1"></div>
      <div className="col-4"><img src={require('../Images/abayakasthaa-image.png')} className="Carousel-img" alt="image" />
...
{/* Phone Carousel */}
       ...
       <div id="carouselExampleIndicators" class="carousel slide single-page-caresouel" data-bs-ride="carousel">
