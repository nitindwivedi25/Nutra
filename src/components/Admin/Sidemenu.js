...
$(document).ready(function() {
    ...
    <div id="body-pd " className="dasboard-nav" style={{position:'relative'}}>
                    ...
                    <div className="row">
                        <div className="col-2">
                            <div className="header__toggle">
                                <i className='bx bx-menu header-toggle-button' id="header-toggle"></i>
                            </div>
                        </div>
                        {/* <div className="col-4">
    ...
    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      ...
      <ul className="Configration-List">
                        <Link to={"/NewOrder/" + "Pending"}><li>New Orders</li></Link>
                        <Link to={"/NewOrder/" + "In Progress"}> <li>In Progress</li></Link>
                        <Link to={"/NewOrder/" + "Packed"}><li>Packed</li></Link>
                        <Link to={"/NewOrder/" + "Shipped"}><li>Shipped</li></Link>
                        <Link to={"/NewOrder/" + "Cancel"}><li>Cancel Order</li></Link>
                        <Link to={"/NewOrder/" + "Delivered"}> <li>Delivered</li></Link>
                        ...
                        <Link to="#" className="nav__link">
                            ...
                            <span className="nav__name"><div class="accordion" id="accordionExample">
  ...
  <div class="accordion-item">
    ...
    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      ...
      <ul className="Configration-List">
                        <Link to="/Manufacturer" ><li>Manufacturer</li></Link>    
                        <Link to="/Category" >   <li>Category</li> </Link>
                        <Link to="/SubCategoryCreation" >   <li>SubCategory</li></Link>
                        <Link to="/Roles" >   <li>User Roles</li></Link>
                            
                        </ul>:    <ul className="Configration-List">                       
                        <Link to="/Roles" >   <li>User Roles</li></Link>                            
                        </ul>:
                       null
                    }
                ...
                <div className="nav__link" onClick={()=>logout()}>
                    ...
                    <span className="nav__name" style={{cursor:'pointer'}}>Log Out</span>
